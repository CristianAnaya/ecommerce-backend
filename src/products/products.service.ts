...
export class ProductsService {
    ...
    async create(files: Array<Express.Multer.File>, product: CreateProductDto) {
        ...
        let uploadedFiles = 0; // Count how many files upload it to Firebase
    ...
    async updateWithImage(files: Array<Express.Multer.File>, id: number, product: UpdateProductDto) {
        ...
        let counter = 0;
        let uploadedFiles = Number(product.images_to_update[counter]); // Count how many files upload it to Firebase
